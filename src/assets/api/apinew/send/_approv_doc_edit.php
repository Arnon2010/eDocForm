...
for ( $i=0;$i < $countfiles; $i++ ){
    ...
    if(move_uploaded_file($filetemp, $filePath_not_signed) ){ 
        ...
        if(mysqli_query($con, $objsql)){
            ...
            $detailIdNew = mysqli_insert_id($con);

            // Add to sign move
            $sql_move = "INSERT INTO sign_move SET 
                main_id = '$mainId',
                detail_id = '$detailIdNew',
        ...
        // update detail old    
        $objsql_udmv = "UPDATE sign_move SET move_status = '5' WHERE detail_id = '$detailId'";
        mysqli_query($con, $objsql_udmv);
