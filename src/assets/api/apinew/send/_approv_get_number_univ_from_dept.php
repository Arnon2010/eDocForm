...
if($objdata['sent_no'] == ''){
    ...
    $sql = "INSERT INTO edoc_sent_no (edoc_type_id, sent_no, sent_year, depart_id) 
                values('$docTypeId', '$No', '$Year', '$departId')";
}else{
...
if(mysqli_query($con, $objsql_doc)){
    ...
    ## Add edoc_univ_no กรณีมหาลัยออกเลขให้หน่วยงานอื่น
    $objuniv_number = mysqli_query($con, "INSERT INTO edoc_univ_no SET edoc_id = '$edocId', 
        depart_id = '$departId'
    ");
